//============================================================================
//
//% Student Name 1: Arshdeep Singh Bhullar
//% Student 1 #: 301326478
//% Student 1 user id (email): asb29 (asb29@sfu.ca)
//
//% Student Name 2: Siavash Rezghighomi
//% Student 2 #: 301311417
//% Student 2 userid (email): srezghig (srezghig@sfu.ca)
//
...
//     while(CHUNK_SZ > 255)
//     {
//         CHUNK_SZ = CHUNK_SZ - 256 ;    //variable chunk_sz would be overwritten
//     }

     //Since being a 8-bit number, it will always be less than 256
     //blkNum = CHUNK_SZ;

     //Assigning Block Number
    // blkNum(1); // since first block number should be = 1


     //when the block number = 256, it should go back to 0;
     if(blkNum > 255)
     {
         blkNum = blkNum - 256;
     }
